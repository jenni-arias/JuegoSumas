...
public class LevelSQLiteHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "DBLevel.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(LevelContract.LevelScheme.SQL_CREATE_TABLE);
    }

    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        //Se elimina la versión anterior de la tabla
        db.execSQL(LevelContract.LevelScheme.SQL_DELETE_TABLE);
